...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fa-solid fa-plus" style="margin-right: 5px;"></i> Novo Produto</h3>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <input type="text" name="nome" class="form-control" value="{{ old('nome') }}" placeholder="Ex: Smartphone Galaxy S23" required>
                    @error('nome')
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="text" name="preco" class="form-control price-input" style="padding-left:35px;" value="{{ old('preco') }}" placeholder="0,00" required>
                    </div>
                    @error('preco')
                        <span class="text-danger small">{{ $message }}</span>
                    @enderror
            ...
            <div class="mb-3">
                ...
                <textarea name="descricao" class="form-control" rows="4" maxlength="500" placeholder="Descreva as características, especificações e benefícios do produto...">{{ old('descricao') }}</textarea>
